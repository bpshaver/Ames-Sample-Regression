...
parser.add_argument('--kaggl_path', default='data/test.csv',
                    help='Where to find the Kaggle test data')
parser.add_argument('--submission_path', default=None,
                    help='Where to write the submission CSV to')
parser.add_argument('--brute', default=False,
                     help='Whether to do brute force feature engineering.')
parser.add_argument('--interaction_only', default=True,
                    help='Whether or not to only include interaction terms \
                    in brute force feature engineering')
parser.add_argument('--run_lin', default=True, help='Whether to run linear regression')
parser.add_argument('--run_ridge', default=True, help='Whehter to run Ridge regression')
parser.add_argument('--run_las', default=True, help='Whether to run LASSO regression')
parser.add_argument('--run_elnet', default=True, help='Whehter to run Elastic Net regression')
...
if __name__ == '__main__':
    ...
    kaggl_path  = args.kaggl_path
    submission_path = args.submission_path
    brute = args.brute
    interaction_only = args.interaction_only
    run_lin = args.run_lin
    run_ridge = args.run_ridge
    run_las = args.run_las
    run_elnet = args.run_elnet
